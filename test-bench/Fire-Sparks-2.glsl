...
// *TO-DO* Simplify Seed Hash, Float
    ...
    // Composite Possibly Not needed 
    vec3 col = termCol + rain * (1.0 - termLum * 0.95);

    // Soft bloom on terminal needs smoothing
    vec3 bloom = vec3(0.0);
    ...
    // Scanlines Need Brought in flr High Rez Displays  
